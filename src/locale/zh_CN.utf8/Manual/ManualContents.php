...
/**
 * 已删除不需要的章节，取消了打印勾选框
 * 之前的备份为Manual/ManualContents_bak.php
 */
...
<!--               <input type="checkbox" name="SelectInventory"> -->
              <A HREF="<?php echo htmlspecialchars($_SERVER['PHP_SELF'],ENT_QUOTES,'UTF-8') . '?ViewTopic=Inventory'; ?>">库存 (“存货”)</A>
<?php
  } else {
?>
              <A HREF="#Inventory">库存 (“存货”)</A>
<?php
  }
?>
              <UL>
